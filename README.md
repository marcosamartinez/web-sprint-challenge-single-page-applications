...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   The useRouteMatch hook is used for creating needed paths and allowing access to the object.
1. How would you explain form validation to someone who has never programmed before?
   Form validation is the process where you are checking what the user is inputing and connecting that back to the expected data.
1. In 1-2 sentences, define end to end testing.
   End to end Testing is the process of testing a specific function or many functions within a unit of your application. You can test the funtionality and performance of the application in a isolated environment to test the data being expected as you desire.
